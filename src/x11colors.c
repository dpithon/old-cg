...
#define NR (sizeof(x11colors) / sizeof(x11colors[0]))
#define CAPITALIZE(c)	(c | 65)
...
int main()
{
	printf(
		"#ifndef RGB_H\n"
		"#define RGB_H\n\n"
		"/* rgb.h: file generated by x11colors. */\n\n"
		"struct rgb {\n"
		"\tdouble r;\n"
		"\tdouble g;\n"
		"\tdouble b;\n"
